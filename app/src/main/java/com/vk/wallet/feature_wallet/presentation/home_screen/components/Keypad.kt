...
import com.vk.wallet.ui.theme.GridBorderGray
...
fun Keypad(
    ...
    ConstraintLayout(
        ...
        val (keySeven, keyEight, keyNine, keyClear) = createRefs()
        ...
        val scalePoint = animateFloatAsState(
            ...
            animationSpec = tween(easing = LinearOutSlowInEasing), label = "Button Point"
        )
        ...
        Button(
            ...
            shape = MaterialTheme.shapes.small,
            colors = ButtonDefaults.buttonColors(MaterialTheme.colorScheme.primaryContainer.copy(alpha = 0.1f)),
            elevation = ButtonDefaults.buttonElevation(
                defaultElevation = 0.dp,
                pressedElevation = 0.5.dp
            ),
        ...
        Button(
            ...
            shape = MaterialTheme.shapes.small,
            colors = ButtonDefaults.buttonColors(LightBlue500),
            elevation = ButtonDefaults.buttonElevation(
                defaultElevation = 0.dp,
                pressedElevation = 0.5.dp
            ),
