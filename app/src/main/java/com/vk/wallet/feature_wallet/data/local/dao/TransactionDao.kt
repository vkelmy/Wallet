package com.vk.wallet.feature_wallet.data.local.dao
...
interface TransactionDao {
    ...
    fun getCurrentDayExpTransaction(transactionType: String = Constants.EXPENSE): Flow<List<TransactionEntity>>
    ...
    fun getWeeklyExpTransaction(transactionType: String = Constants.EXPENSE): Flow<List<TransactionEntity>>
    ...
    fun getMonthlyExpTransaction(transactionType: String = Constants.EXPENSE): Flow<List<TransactionEntity>>
